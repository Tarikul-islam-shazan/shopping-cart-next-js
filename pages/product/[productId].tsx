...
const ProductDetails = () => {
    ...
    if(isLoading){
        ...
        content = <div className="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">Error data fetching</div>
    }else{
        content = 
                    ...
                    <div className="w-full px-4 md:w-1/2 ">
                        <div className="lg:pl-20">
                            <div className="pb-6 mb-8 ">
                                ...
                                <h2 className="max-w-xl mt-2 mb-6 text-xl font-bold dark:text-gray-600 md:text-4xl">
                                {data?.title}
                                </h2>
                                ...
                                {/* <div className="p-4 mb-8 border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div className="w-full bg-gray-200 rounded-full h-2.5  dark:bg-gray-600">
                                        <div className="bg-blue-600 dark:bg-blue-400 h-2.5 rounded-full" style={{ width:'45%' }}>
                                        </div>
                                    </div>
                                </div> */}
